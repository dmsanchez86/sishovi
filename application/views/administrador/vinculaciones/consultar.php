...
<div class="ui form segment teal">
  <div class="three fields">
    <div class="field">
        <input id="busqueda" type="text" placeholder="Documento">
    </div>
    <div class="field">
    ...
    <div class="field">
      <div  id="consultarVin" class="ui teal labeled icon button">
...
<table class="ui celled table" id="respuesta">
  <h4 class="ui dividing header">Informacion de Vinculaciones</h4>
